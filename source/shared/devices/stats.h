...
public:
    ...
    void reset(){ data().reset(); msgs().reset(); }
...
class session_stats {
    ...
    void do_stat_check(boost::system::error_code ec){
        ...
        timer_.async_wait(std::bind(&session_stats::do_stat_check, this, std::placeholders::_1));
    }
